...
const CarItem = (props) => {
  return(
    ...
    <View style={styles.iconBorder}>
    <FontAwesomeIcon icon={faUnlockAlt} style={styles.icon} size={24}/>
    </View>
</View>
    ...
    <Text style={styles.menuText}>Software upadtes</Text>
    <Text style={styles.menuText}>Approximate time to install: 45min</Text>
    <FontAwesomeIcon icon={faChevronRight} style={styles.icon} size={24}/>
    </View>
    ...
    <Text style={styles.menuText}>Interior 20°F</Text>
    <FontAwesomeIcon icon={faChevronRight} style={styles.icon} size={24}/>
    </View>
